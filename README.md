...
4. Next, make sure that the **TOI_list.txt** file is properly configured. The comments in the **TOI_list.txt** file provide suggested values for these parameters.
  ...
  * For our example run we will use a file set up for two TOI/TIC's. 
...
```dos
 ...
 /home/cfvm/anaconda3/envs/eleanor_env/lib/python3.7/site-packages/transitleastsquares/main.py:404: UserWarning: 21   of 33 transits without data. The true period may be twice the given period.
   warnings.warn(text)
 ...
 /home/cfvm/anaconda3/envs/eleanor_env/lib/python3.7/site-packages/transitleastsquares/main.py:404: UserWarning: 47   of 69 transits without data. The true period may be twice the given period.
   warnings.warn(text)
...
|:--------------------------------|:---------------------------------------------------------------------|
| TIC 142748283_pc_1.svg          | full target vetting sheet for TOI 2096, planet cadidate 1            |
| TIC 142748283_pc_2.svg          | full target vetting sheet for TOI 2096, planet cadidate 2            |
...
## Acknowledgments
The code discussed here was developed as part of a group project at the University of California, Berkeley, under the guidance of Prof. Courtney Dressing. I would like to thank Andrew Mayo (UCB graduate student) for certain code elements related to detrending of the TESS lightcurves, and for his many helpful suggestions.  I would also like to thank Shishir Dolakia (UCB student) for his helpful comments.
